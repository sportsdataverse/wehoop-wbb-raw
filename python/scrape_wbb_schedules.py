...
logging.basicConfig(level=logging.DEBUG, filename = 'wehoop_wbb_raw_logfile.txt')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--start_year", "-s", type = int, required = True, help = "Start year of WBB Schedule period (YYYY)")
