...
Seven such files were found in ``wbb/team_stats/json/`` when the sdv-py payload
...
@pytest.mark.parametrize(
    "pattern",
    [
        "wbb/team_stats/json/*/*.json",
        "wbb/officials/json/*.json",
        "wbb/standings/json/*.json",
        "wbb/player_season_stats/json/*/*.json",
    ],
)
