...
sides. This archive currently ships ``game_id``/``athlete_id``/``team_id`` as
Int32 while play ids (18 digits) and the wider ecosystem are Int64 -- the same
mismatch class that the CFB loader-boundary canonicalization exists to close.
